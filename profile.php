...
<body>
    <div class="form2">
        ...
        <div class="navbar">
            ...
            <a href="update.php">
                <button class="btn"><i class="fa fa-user"></i> Update Profile</button>
            </a>
                    ...
                    <div class="container">
                        <svg id="circle-nav-services" width="100%" height="100%" viewBox="0 0 650 550">
                            ...
                            <symbol id="circle-nav-copy" viewBox="0 0 300 300">
                                ...
                                <text class="cls-1" transform="translate(87 65)">Homepage</text>
                                <text class="cls-5" transform="translate(63 108)">From here You can return
                                    <tspan x="-9" y="19">back to main home page</tspan>

                                    <tspan class="cls-8" x="-1" y="38">r</tspan>
                                    <tspan x="4" y="38">ange of industries in the </tspan>
                                    <tspan x="3" y="60">Click Below </tspan>
                                    <tspan x="50" y="150"><a href="login.php">Click Here</a></tspan>
                                </text>

                                <text class="cls-1" transform="translate(87 365)">
                                    <tspan class="cls-17">S</tspan>
                                    <tspan x="18" y="0">uppliers</tspan>
                                    <tspan x="20" y="33">Details</tspan>
                                </text>
                                <text class="cls-5" transform="translate(46 437)">As pa
                                    ...
                                    <tspan x="67" y="120"><a href="supplier_details.php">Click Here</a></tspan>
                                </text>
