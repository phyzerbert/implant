...
const services_data = [
{ name: "Home", icon: "industries" },
{ name: "Suppliers\nDetails", icon: "validation" },
{ name: "Open\nQuotations", icon: "engineering" },
{ name: "Order\nAwarded", icon: "management" },
{ name: "Create\Vendor", icon: "manufacturing" },
{ name: "Update\nProfile", icon: "technical" },
{ name: "Change\nPasssword", icon: "process" }];
